...
<div id="profileSection" class="col-7 mx-3 pt-4 mx-5">
        ...
        <div class="col-md-6">
            <div class="card-body h-75 p-5 ">
                <h6 style="color: #243763;" class="card-title p-2"> <i class="fa-solid fa-user mx-2"></i>  Name  : <strong class="text-secondary">  <?= $_SESSION["admin"] ?>  </strong></h6>
                <h6 style="color: #243763;" class="card-title p-2"><i class="fa-solid fa-envelope mx-1"></i> Email :<strong class="text-secondary"> <?= $_SESSION["email"]   ?> </strong></h6>
